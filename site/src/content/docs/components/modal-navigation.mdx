...
<button rel="back">← Back</button>        <!-- Go to previous screen -->
    ...
    const first = new Bravo.Modal({
      ...
      content: `
        <div class='py-3'>
          ...
          <button rel='second' class='btn btn-primary'>Continue →</button>
        </div>
      `
    });
      ...
      content: `
        <div class='py-4'>
          ...
          <div class='d-flex gap-2'>
            <button rel='back' class='btn btn-secondary'>← Back</button>
            <button rel='third' class='btn btn-primary'>Next →</button>
          </div>
        </div>
      `
    });
    ...
    const first = new Bravo.Modal({
      ...
      content: `
        <div class='py-2'>
          ...
          <button rel='second' class='btn btn-primary'>See it morph →</button>
        </div>
      `
    });
    ...
    const second = new Bravo.Modal({
      ...
      content: `
        <div class='py-4'>
          ...
          <div class='d-flex gap-2'>
            <button rel='back' class='btn btn-secondary'>← Smaller</button>
            <button rel='third' class='btn btn-primary'>Bigger →</button>
          </div>
        </div>
      `
    });
...
- **Navigation stack** — Push/pop screens instead of stacking multiple modals
- **Automatic back button** — Appears when needed (stack > 1), no manual wiring
- **Smooth transitions** — Slide or morph animations between screens
- **Declarative navigation** — Use `rel` attributes to wire up navigation
- **Modal reuse** — Previously shown modals are cached and reused
- **Single backdrop** — No z-index issues or backdrop flashing
- **CSS hooks** — `.modal-navigation` and `.modal-navigation-stacked` classes for custom styling