  ...
  <div class="col-md-6">
    <div class="card h-100">
      <div class="card-body">
        ...
        <a href="[[docsref:/design-tokens/color-system/]]" class="btn btn-primary">Explore tokens</a>
      </div>
    </div>
  </div>
  <div class="col-md-6">
    <div class="card h-100">
      <div class="card-body">
        ...
        <a href="[[docsref:/components/modal/]]" class="btn btn-primary">View components</a>
      </div>
    </div>
  </div>
  <div class="col-md-6">
    <div class="card h-100">
      <div class="card-body">
        ...
        <a href="[[docsref:/javascript/dynamic-observer/]]" class="btn btn-primary">See features</a>
      </div>
    </div>
  </div>
  <div class="col-md-6">
    <div class="card h-100">
      <div class="card-body">
        ...
        <a href="[[docsref:/getting-started/migration-guide/]]" class="btn btn-primary">Start migrating</a>
      </div>
    </div>
  </div>
</div>