...
<div class="alert alert-info mt-4">
  <strong>Auto-initialization:</strong> Dropdowns with <code>data-bs-toggle="dropdown"</code> are automatically enhanced when added to the DOM, even dynamically. Powered by Bravo's <a href="/docs/0.0/javascript/dynamic-observer/">DynamicObserver</a>.
</div>