...
/* harmony import */ var bravo_js_tooltip__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! bravo/js/tooltip */ "../js/tooltip.js");
...
const childModal = new bravo_js_modal__WEBPACK_IMPORTED_MODULE_0__["default"]({
  id: "child",
  title: "CHILD!",
...
const grandchildModal = new bravo_js_modal__WEBPACK_IMPORTED_MODULE_0__["default"]({
  title: "GRANDCHILD!",
  content: "Hejsan ? Hejsan här är jag från ett child med lite mer innehåll än min parent, vi får se hur det blir när vi transformeras fram och tillbaka helt nekelt.<br /><br />Vad tycks?? Hejsan här är jag från ett child med lite mer innehåll än min parent, vi får se hur det blir när vi transformeras fram och tillbaka helt nekelt.<br /><br />Vad tycks??"
});
const Nav = new bravo_js_modal__WEBPACK_IMPORTED_MODULE_0__.ModalNavigation({
  animation: "morph"
  /* closeButton: {
    disabled: true
   },
